...
const TRANSLATIONS = {
  ...
  ca: {
    ...
    /* Extracció de sang — pendent de traducció (CA) */
    'pildoras.extraccion-sangre.titulo':       '[Pendent de traducció] La muestra que crece en valor con el tiempo',
    'pildoras.extraccion-sangre.resumenCorto': '[Pendent de traducció — la versió catalana arribarà aviat.] Una extracción de sangre de pocos minutos permite hoy medir cosas que hace diez años no podíamos.',
    'pildoras.extraccion-sangre.resumen':      '[Pendent de traducció — la versió catalana arribarà aviat.]',
    'pildoras.extraccion-sangre.desarrollo':   '<p><em>Pendent de traducció — la versió catalana completa arribarà aviat. Mentrestant, pots consultar la versió en castellà.</em></p>',
    'pildoras.extraccion-sangre.conclusion':   '[Pendent de traducció — la versió catalana arribarà aviat.]',
