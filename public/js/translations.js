...
const TRANSLATIONS = {
  ...
  en: {
    ...
    /* Blood draw — translation pending (EN) */
    'pildoras.extraccion-sangre.titulo':       '[Translation pending] La muestra que crece en valor con el tiempo',
    'pildoras.extraccion-sangre.resumenCorto': '[Translation pending — the English version will arrive soon.] A few minutes of blood draw now lets us measure things we couldn\'t ten years ago.',
    'pildoras.extraccion-sangre.resumen':      '[Translation pending — the English version will arrive soon.]',
    'pildoras.extraccion-sangre.desarrollo':   '<p><em>Translation pending — the full English version will arrive soon. In the meantime, you can read the Spanish version.</em></p>',
    'pildoras.extraccion-sangre.conclusion':   '[Translation pending — the English version will arrive soon.]',
