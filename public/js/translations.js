...
const TRANSLATIONS = {
  ...
  gl: {
    ...
    /* Extracción de sangue — pendente de tradución (GL) */
    'pildoras.extraccion-sangre.titulo':       '[Pendente de tradución] La muestra que crece en valor con el tiempo',
    'pildoras.extraccion-sangre.resumenCorto': '[Pendente de tradución — a versión galega chegará pronto.] Una extracción de sangre de pocos minutos permite hoy medir cosas que hace diez años no podíamos.',
    'pildoras.extraccion-sangre.resumen':      '[Pendente de tradución — a versión galega chegará pronto.]',
    'pildoras.extraccion-sangre.desarrollo':   '<p><em>Pendente de tradución — a versión galega completa chegará pronto. Mentres tanto, podes consultar a versión en castelán.</em></p>',
    'pildoras.extraccion-sangre.conclusion':   '[Pendente de tradución — a versión galega chegará pronto.]',
