...
const TRANSLATIONS = {
  ...
  ca: {
    ...
    /* Polisomnografia — pendent de traducció (CA) */
    'pildoras.polisomnografia.titulo':       '[Pendent de traducció] Lo que tu cerebro cuenta mientras duermes',
    'pildoras.polisomnografia.resumenCorto': '[Pendent de traducció — la versió catalana arribarà aviat.] La polisomnografía es un estudio del sueño que permite observar cómo funciona tu cerebro durante la noche.',
    'pildoras.polisomnografia.resumen':      '[Pendent de traducció — la versió catalana arribarà aviat.]',
    'pildoras.polisomnografia.desarrollo':   '<p><em>Pendent de traducció — la versió catalana completa arribarà aviat. Mentrestant, pots consultar la versió en castellà.</em></p>',
    'pildoras.polisomnografia.conclusion':   '[Pendent de traducció — la versió catalana arribarà aviat.]',
