...
const TRANSLATIONS = {
  es: {
    ...
    /* Píldora Polisomnografía (categoría: pruebas; especialmente útil en portadores de FFI) */
    'pildoras.polisomnografia.titulo':       'Lo que tu cerebro cuenta mientras duermes',
    'pildoras.polisomnografia.resumenCorto': 'La polisomnografía es un estudio del sueño que permite observar cómo funciona tu cerebro durante la noche. En portadores de FFI es una de las pruebas más sensibles del programa. Te contamos cómo es y por qué vale la pena.',
    'pildoras.polisomnografia.resumen':      'La polisomnografía es una prueba que registra lo que ocurre en tu cuerpo durante una noche de sueño: la actividad eléctrica del cerebro, los movimientos oculares, la respiración, el ritmo cardíaco, el tono muscular. Es una de las pruebas más valiosas en el seguimiento de portadores de Insomnio Familiar Fatal, porque los cambios relacionados con esta mutación aparecen en el sueño mucho antes que en ningún otro sitio.',
    'pildoras.polisomnografia.desarrollo':   '<h3>Una prueba pensada especialmente para portadores de FFI</h3><p>A diferencia de otras pruebas del programa, la polisomnografía no se realiza en todos los portadores. Tiene un valor especialmente alto en personas portadoras de la mutación asociada al Insomnio Familiar Fatal, porque los primeros cambios detectables en esta enfermedad ocurren precisamente en la arquitectura del sueño. Por eso, si eres portador de otra mutación, probablemente no te la propondrán.</p><p>Esto no es una jerarquía ni una exclusión: simplemente cada prueba tiene una fortaleza distinta, y usarlas donde son más informativas es una forma de cuidar también tu tiempo y tu comodidad.</p><h3>El sueño no es pasivo</h3><p>Durante años se pensó que el sueño era un estado de apagado. Hoy sabemos que es justo lo contrario: mientras duermes, tu cerebro está realizando un trabajo extraordinariamente organizado. Consolida lo aprendido durante el día, limpia residuos moleculares, regula hormonas, orquesta ritmos. Lo hace a través de varias fases que se repiten cíclicamente, cada una con su propio patrón de actividad.</p><p>Entre estas fases hay una señal especialmente interesante: los llamados <em>husos de sueño</em>. Son pequeñas ráfagas rítmicas de actividad eléctrica que el cerebro genera en ciertos momentos del sueño profundo, como pulsos organizados. Están generados por una región del cerebro llamada tálamo, y su presencia, su forma y su cantidad son un indicador muy fiable de que el tálamo funciona bien.</p><p>En el Insomnio Familiar Fatal, el tálamo es justo la región que se ve afectada. Por eso los husos de sueño pueden dar pistas sutiles mucho antes que cualquier otra prueba, incluso años antes de que aparezcan síntomas.</p><h3>Cómo es la prueba, paso a paso</h3><p>La polisomnografía se realiza en una unidad de sueño, normalmente en un hospital. Pasarás una noche completa allí.</p><p>Al llegar, por la tarde-noche, un técnico te preparará: te colocará pequeños sensores adheridos con una pasta especial en varias partes del cuerpo. En el cuero cabelludo para registrar la actividad eléctrica del cerebro, cerca de los ojos para los movimientos oculares, en el mentón y las piernas para el tono muscular, en el pecho para el corazón, y unas cintas suaves alrededor del tórax y el abdomen para medir la respiración. También llevarás un pequeño sensor en el dedo para medir la oxigenación.</p><p>Pueden parecer muchos cables, y lo son, pero los sensores son pequeños y están diseñados para ser lo menos molestos posible. Una vez colocados, puedes moverte, darte la vuelta, ir al baño con ayuda del técnico.</p><p>Después te acuestas en una cama normal, en una habitación tranquila y oscurecida. El equipo graba toda la noche sin que tengas que hacer nada. Por la mañana, el técnico retira los sensores y te vas a casa.</p><h3>Cómo es, realmente, pasar la noche ahí</h3><p>Es la pregunta que todo el mundo se hace y pocas personas se atreven a formular. La respuesta honesta: <em>es raro la primera vez</em>. Dormir en una cama que no es la tuya, con cables conectados al cuerpo, en una habitación desconocida, en un edificio hospitalario… no es lo más natural del mundo. Mucha gente duerme peor de lo habitual esa noche.</p><p>Y esa es precisamente la buena noticia: no hace falta dormir perfectamente. El estudio captura información útil incluso cuando el sueño es más fragmentado de lo normal. Lo que se analiza no es <em>cuánto</em> has dormido, sino <em>cómo</em> ha sido la arquitectura del sueño cuando lo has hecho. Aunque duermas solo unas horas, los datos son válidos.</p><p>Algunos consejos prácticos que suelen ayudar: llevar un pijama cómodo al que tengas cariño, tu almohada si puedes, algo para leer antes de apagar la luz, no tomar café ni alcohol ese día. Y, sobre todo, ir tranquilo: el equipo está habituado a que los participantes no duerman como en casa, y saben trabajar perfectamente con ello.</p><h3>Qué información nos aporta</h3><p>De una sola noche bien registrada se puede extraer muchísima información:</p><ul><li>Un <strong>mapa detallado de tu arquitectura del sueño</strong>: cuánto tiempo pasas en cada fase, con qué calidad, con qué estabilidad.</li><li>Un <strong>análisis fino de los husos de sueño</strong>: su número, su frecuencia, su distribución. En FFI, este es el dato más valioso.</li><li>Información sobre la <strong>respiración, el ritmo cardíaco y los movimientos durante la noche</strong>, que permiten descartar otras alteraciones del sueño no relacionadas con tu mutación, como apneas u otros fenómenos.</li></ul><h3>Cada cuánto se repite</h3><p>Como ocurre con el resto de pruebas del programa, la frecuencia de la polisomnografía se ajusta a la edad media de inicio de los síntomas. Para el Insomnio Familiar Fatal, esa edad ronda los 49 años. A partir de ahí, el criterio del programa es este:</p><table><thead><tr><th>Tu situación respecto al inicio medio</th><th>Frecuencia de la polisomnografía</th></tr></thead><tbody><tr><td>Más de 20 años antes</td><td>Cada 3 años</td></tr><tr><td>Entre 20 y 10 años antes</td><td>Cada 2 años</td></tr><tr><td>Menos de 10 años antes, o por encima de la edad media</td><td>Cada año</td></tr></tbody></table><p>La lógica es la misma que en el resto del seguimiento: cuanto más cerca de la franja en la que estadísticamente podrían aparecer cambios, más valioso es mirar con frecuencia. Y, como siempre, el programa te avisa cuando toca.</p>',
    'pildoras.polisomnografia.conclusion':   'La polisomnografía es una prueba singular dentro del programa: no todos los portadores la hacen, y pedirla supone renunciar a una noche de sueño en casa. A cambio, ofrece algo que ninguna otra prueba puede dar: una ventana al trabajo silencioso que tu cerebro realiza cada noche, y la posibilidad de detectar antes que nadie un cambio sutil si alguna vez ocurriera. Es, en cierto modo, dejar que tu cerebro hable por ti mientras descansas.',

    /* Píldora Extracción de sangre (categoría: pruebas; sin tabla, cadencia anual fija) */
    'pildoras.extraccion-sangre.titulo':       'La muestra que crece en valor con el tiempo',
    'pildoras.extraccion-sangre.resumenCorto': 'Una extracción de sangre de pocos minutos permite hoy medir cosas que hace diez años no podíamos, y mañana permitirá medir cosas que hoy no existen. Te contamos qué se analiza y por qué esta prueba es probablemente la que más está cambiando.',
    'pildoras.extraccion-sangre.resumen':      'La extracción de sangre es la prueba más sencilla del programa. Todos hemos pasado por una analítica alguna vez, así que no vamos a dedicar mucho espacio a describirla. Lo interesante no es la prueba en sí, sino lo que podemos hacer con la muestra: el campo de los biomarcadores en sangre está viviendo una transformación acelerada, y una sola extracción anual te permite participar en ese avance sin casi esfuerzo por tu parte.',
    'pildoras.extraccion-sangre.desarrollo':   '<h3>La sangre, una versión accesible del LCR</h3><p>Cuando hablamos de la punción lumbar, decíamos que el líquido cefalorraquídeo es el espejo más fiel del sistema nervioso. La sangre es distinta: es más accesible, más abundante, más fácil de recoger, pero también más <em>ruidosa</em>. El cerebro deposita señales en la sangre, pero diluidas, mezcladas con todo lo que aporta el resto del cuerpo. Durante décadas esas señales eran tan tenues que no las podíamos distinguir del ruido de fondo.</p><p>Eso está cambiando. Las nuevas técnicas de detección son capaces de medir concentraciones minúsculas de moléculas específicas en sangre, concentraciones que antes solo podíamos detectar en LCR. Cada año, un biomarcador que hasta ahora solo se podía estudiar por punción lumbar empieza a ser medible en una simple extracción.</p><h3>Qué ya podemos medir hoy</h3><p>El biomarcador más maduro en este campo se llama <strong>NfL</strong>, por sus siglas en inglés <em>neurofilament light chain</em> (cadena ligera de neurofilamento). Los neurofilamentos son parte de la estructura interna de las neuronas, como un esqueleto que las mantiene firmes. Cuando una neurona sufre, libera pequeñas cantidades de NfL al entorno, que acaban llegando a la sangre. Su presencia en niveles elevados es un indicador fiable de que en algún lugar del sistema nervioso está ocurriendo algo.</p><p>En estudios recientes con portadores asintomáticos de mutaciones del gen PRNP, el NfL en sangre empieza a elevarse hasta 2 años antes de que aparezcan síntomas. No es una herramienta diagnóstica definitiva, pero sí un indicador temprano valioso, especialmente cuando se repite en el tiempo y se compara con tus propios niveles previos.</p><p>Junto al NfL, hay otro biomarcador emergente que está cobrando protagonismo: <strong>GFAP</strong>, una proteína que producen unas células de apoyo del cerebro llamadas astrocitos. Cuando estas células se activan —algo que ocurre cuando el entorno neuronal se altera—, el GFAP se libera y llega también a la sangre. Curiosamente, NfL y GFAP reflejan cosas distintas: uno indica daño neuronal directo, el otro una respuesta de las células que rodean a las neuronas. Juntos dan un retrato más completo que cualquiera de los dos por separado.</p><p>Y más allá de estos dos, hay otros candidatos en investigación (variantes de la proteína tau, sinucleína, YKL-40, y otros) que van madurando a distinto ritmo. Algunos se consolidarán, otros probablemente no. Así avanza la ciencia: probando muchas cosas, validando unas y descartando otras con la misma honestidad.</p><h3>Un momento histórico en el campo</h3><p>Hace diez años, hablar de biomarcadores en sangre para enfermedades neurodegenerativas era casi ciencia ficción. Hoy hay técnicas de ultrasensibilidad que están cambiando por completo el panorama. En los próximos años es razonable esperar que aparezcan nuevos biomarcadores, que los actuales se refinen, y que la combinación de varios de ellos permita responder preguntas que hoy todavía no sabemos ni formular.</p><p>Tu participación en este programa te coloca justo en la primera fila de ese avance. Cada extracción contribuye a que los laboratorios puedan afinar sus técnicas, comparar resultados longitudinales, y construir el mapa detallado del comportamiento de estos biomarcadores en la fase preclínica.</p><h3>El biobanco: muestras guardadas para un futuro mejor</h3><p>No todo lo que se extrae se analiza de inmediato. Una parte de cada muestra se guarda cuidadosamente, congelada a muy baja temperatura, en lo que se llama un biobanco. Estas muestras quedan a disposición del programa para ser analizadas en el futuro, cuando existan técnicas que hoy todavía no se han inventado.</p><p>Esta es una de las ideas más bonitas del seguimiento longitudinal: una muestra de tu sangre tomada hoy podrá analizarse dentro de cinco o diez años con métodos que ni siquiera existen ahora, permitiendo responder preguntas que entonces serán relevantes pero que hoy no podemos hacernos. Tu muestra es, en ese sentido, un pequeño viaje en el tiempo: contiene información futura.</p><h3>Por qué estos análisis se hacen en el marco de un programa</h3><p>Los biomarcadores en sangre son prometedores, pero su interpretación todavía requiere contexto. Un valor aislado de NfL o GFAP, sin referencia y sin seguimiento, puede generar más preguntas que respuestas, y a veces ansiedad innecesaria. Por eso, la comunidad científica internacional recomienda que estos análisis se realicen siempre dentro de programas organizados, con seguimiento médico y con la capacidad de poner cada valor en su contexto personal e histórico.</p><p>En este programa esa condición se cumple: cada muestra se analiza con perspectiva, se compara con las tuyas previas, y se interpreta junto al resto de pruebas del seguimiento. No es un cribado suelto. Es parte de una mirada de conjunto, cuidada.</p><h3>Y una conexión con el futuro cercano</h3><p>Si algún día llegas a ser candidato a un ensayo clínico —con alguna de las terapias que están siendo desarrolladas y que contaremos en otras píldoras—, el valor de tu histórico de extracciones se multiplicará. Los investigadores querrán saber cómo estaban tus biomarcadores antes de empezar el tratamiento, para poder medir con precisión si la terapia está funcionando. Ese histórico no se puede reconstruir a posteriori: o se tiene, o no se tiene. Tú, con cada extracción anual, lo estás construyendo.</p><h3>Cómo es la extracción y cada cuánto se hace</h3><p>Poco que añadir: una extracción estándar, de unos pocos tubos, como tantas que has hecho en tu vida. Unos minutos. Ligera molestia del pinchazo y listo.</p><p>La frecuencia en este caso no sigue la cadencia escalonada de las demás pruebas (3/2/1 años). Como es una prueba muy poco invasiva y muy rápida, se realiza <strong>una vez al año</strong> desde el inicio del programa, independientemente de la edad o la cercanía al inicio medio de la enfermedad. Si el programa considera que alguna circunstancia requiere una extracción adicional (por ejemplo, al coincidir con una RMN o una punción lumbar), se te informará con tiempo.</p>',
    'pildoras.extraccion-sangre.conclusion':   'La extracción de sangre es la más humilde de las pruebas del programa, pero quizás la que mejor encarna el espíritu del seguimiento: algo pequeño, sostenido en el tiempo, que se va haciendo valioso por la constancia más que por la intensidad. Hoy tu sangre cuenta lo que la ciencia sabe medir. Mañana contará lo que la ciencia todavía está aprendiendo. Y el programa está aquí para asegurarse de que esa conversación no se interrumpa.',

    /* Píldora 'Así es venir al programa' (categoría: experiencia) */
    'pildoras.dia-programa.titulo':       'Así es venir al programa',
    'pildoras.dia-programa.resumenCorto': 'Una vez al año, dos días en el Hospital Universitario Araba. Te contamos cómo será esa visita desde que llegas hasta que vuelves a casa, y qué ocurre en los meses siguientes.',
    'pildoras.dia-programa.resumen':      'El programa se concentra en una visita anual de dos días al Hospital Universitario Araba, en Vitoria-Gasteiz. Durante esos dos días se realizan todas las pruebas que toquen ese año según tu cadencia personal. Esta píldora es tu mapa anticipado: lo que vas a vivir desde que llegas hasta que te marchas, y cómo seguimos en contacto los meses siguientes.',
    'pildoras.dia-programa.desarrollo':   '<h3>Antes de venir</h3><p>Unos días antes de la visita, recibirás una comunicación del equipo con la información práctica: fechas, hora de llegada, indicaciones sobre desplazamiento y alojamiento, y qué debes traer contigo. Si vienes de fuera del País Vasco, el programa cubre los gastos de viaje y alojamiento, y te ayudará con la logística.</p><p>Recibirás también, con tiempo, los documentos de consentimiento informado que firmarás durante la visita. Poder leerlos con calma en casa, preguntar dudas al equipo antes de venir, y llegar con las ideas claras es parte del programa. No es algo que haya que firmar deprisa.</p><h3>Día 1 — Tarde</h3><p>A tu llegada al hospital, te recibirá el equipo del programa. La primera persona con la que te encontrarás será probablemente la <strong>Dra. Izaro Kortazar</strong>, neuróloga del hospital y coordinadora clínica del programa. Ella es tu punto de referencia durante toda la visita y también entre visitas.</p><p>La tarde del primer día está pensada para ir sin prisa: una conversación inicial con la Dra. Kortazar para ponerse al día de cómo estás, una revisión conjunta de los consentimientos, y las pruebas que no requieren preparación especial —la extracción de sangre, por ejemplo, si toca ese año—.</p><p>Después del atardecer, si ese año toca polisomnografía, pasarás a la unidad de sueño del hospital, donde un técnico te colocará los sensores y te quedarás a dormir. Todo el detalle sobre cómo es esa noche lo contamos en la píldora <em class="lazy-pild" data-target="polisomnografia">Lo que tu cerebro cuenta mientras duermes</em>.</p><h3>Día 2 — Mañana</h3><p>Por la mañana temprano, el técnico de la unidad de sueño retirará los sensores y podrás desayunar. A partir de ahí, se realizan las pruebas del segundo día según lo que toque ese año: la resonancia magnética, la punción lumbar, y cualquier otra prueba específica que esté prevista.</p><p>El orden habitual coloca la <strong>resonancia magnética antes de la punción lumbar</strong>, por un motivo práctico: la imagen de la RMN ayuda a confirmar que todo está en orden antes de un procedimiento más invasivo como la punción lumbar. Este orden es importante, y lo cuidamos siempre.</p><h3>Los consentimientos — un momento importante</h3><p>Durante la visita firmarás varios documentos de consentimiento informado. No es papeleo rutinario: cada consentimiento describe qué se te va a hacer, con qué fin, qué se hará con las muestras y los datos, y cuáles son tus derechos. Firmarlos es un acto reflexivo, y por eso el equipo te da tiempo, espacio y la posibilidad de preguntar todas las veces que necesites.</p><p>En términos generales, firmarás consentimientos relacionados con:</p><ul><li>La <strong>realización de las pruebas</strong> del programa (RMN, punción lumbar, polisomnografía, extracción de sangre).</li><li>El <strong>almacenamiento de muestras biológicas</strong> para análisis actuales y futuros —el biobanco—.</li><li>El <strong>uso de tus datos clínicos</strong> de forma anonimizada dentro del programa y, si así lo decides, en estudios científicos colaborativos.</li><li>La <strong>comunicación de resultados</strong> y cómo prefieres recibirlos.</li></ul><p>Puedes retirar tu consentimiento en cualquier momento, parcial o totalmente, sin que eso afecte a tu relación con el equipo ni a tu derecho a seguir siendo acompañado por el programa si lo deseas. Esta posibilidad no es una fórmula: es real, y se te recordará más de una vez.</p><h3>Antes de irte</h3><p>Antes del alta, tendrás una segunda conversación con la Dra. Kortazar. En ella se revisa cómo ha ido todo, se resuelven las dudas que hayan surgido durante los dos días, y se te adelanta cuándo y cómo recibirás los resultados de las pruebas realizadas. Esta conversación es tan importante como las pruebas: es el momento en el que cierras la visita con calma y sabiendo qué viene a continuación.</p><h3>En los meses siguientes</h3><p>Volver a casa no significa desconectar del programa. Durante los meses hasta la siguiente visita hay varios hilos de contacto:</p><ul><li>Los <strong>resultados de las pruebas</strong> se comunican de forma ordenada cuando están disponibles. Algunos son inmediatos, otros requieren semanas de análisis en laboratorio. Siempre se explican con contexto y sin dejar preguntas en el aire.</li><li>La <em class="lazy-pild" data-target="historia-natural-app">app de historia natural</em> —que tendrá su propia píldora— te acompaña en tu día a día, permitiéndote registrar pequeñas observaciones que enriquecen el seguimiento. Es una herramienta opcional pero valiosa.</li><li>El <strong>equipo sigue disponible</strong> para cualquier duda que te surja, clínica o no. Puedes escribir o llamar cuando lo necesites, sin esperar a la próxima visita.</li><li>La <strong>Dra. Kortazar</strong> mantiene tu seguimiento clínico durante el año, y es tu interlocutora principal si aparece alguna pregunta médica específica.</li></ul><h3>La siguiente visita</h3><p>Unos meses antes de que toque tu siguiente visita anual, el equipo se pondrá en contacto contigo para coordinar fechas. La cadencia exacta de cada prueba se ajusta a tu situación personal (como hemos contado en las píldoras de cada prueba), y el programa lleva la cuenta por ti. Tú no tienes que recordar ni calcular nada.</p>',
    'pildoras.dia-programa.conclusion':   'Venir al programa es más sencillo de lo que parece a primera vista. Son dos días concentrados, con todo el cuidado puesto para que te sientas bien acompañado, y luego una presencia discreta pero constante del equipo durante el resto del año. No es una cita médica al uso: es una forma de cuidarte en el presente, con la mirada tranquila puesta en lo que pueda venir.',
  ...
  eu: {
    ...
    /* Giltzurrun-zilborrestearen zulaketa pilula (kategoria: probak) */
    'pildoras.puncion-lumbar.titulo':       'Burmuina bainatzen duen likidoari entzutea',
    'pildoras.puncion-lumbar.resumenCorto': 'Giltzurrun-zilborrestearen zulaketa baten bidez, burmuina eta bizkarrezur-muina inguratzen dituen likidoaren lagin txiki bat lortzen da, neurologian dauden informazio-iturri baliotsuenetako bat. Nolakoa den, zer informazio ematen duen eta zergatik merezi duen kontatzen dizugu.',
    'pildoras.puncion-lumbar.resumen':      'Likido zefalorrakideoa —LZR— burmuina eta bizkarrezur-muina bainatzen dituen likido garden bat da. Nerbio-sistemarekin zuzeneko kontaktuan dagoenez, gorputzeko beste inon halako argitasunez aurkitzen ez diren arrasto molekularrak ditu disolbaturik. Giltzurrun-zilborrestearen zulaketa likido horren lagin txiki bat lortzeko egiten den prozedura da, aztertzeko.',
    'pildoras.puncion-lumbar.desarrollo':   '<h3>Zergatik den hain baliotsua likido zefalorrakideoa</h3><p>Burmuina eta bizkarrezur-muina ez daude hutsean flotatzen: likido garden batean bilduta daude, LZR, babesten, elikatzen eta jariatzen dutena jasotzen dituena. Nolabait, nerbio-sistemaren ispilu zintzoena da.</p><p>Odolean, burmuineko seinale molekularrak oso diluituta iristen dira —iristen direnean—, izan ere, oztopo biologiko batek (hematoenzefaliko oztopoa deitua) arretaz iragazten du zer pasatzen den alde batetik bestera. LZR, ordea, oztopo horren beste aldean dago, behatu nahi duguna zuzenean ukitzen. Horregatik, LZR lagin txiki batek sarri odol-analisi batek, osatuena izanda ere, eman ezin digun informazioa eduki dezake.</p><p>Gurea bezalako jarraipen-programa batean, informazio hori bereziki baliagarria da: LZR-ak aukera ematen digu, halakorik balego, zure mutazioari lotutako jardueraren lehen arrastoak detektatzeko, inolako sintomarik agertu baino askoz lehenago.</p><h3>Nolakoa den proba, urratsez urrats</h3><p>Giltzurrun-zilborrestearen zulaketa prozedura sinple bat da, neurologian ondo ezaguna eta mende bat baino gehiagotik burutua. Kontsultan edo eguneko ospitalean egiten da, ez du ingresorik eskatzen, eta 15 eta 30 minutu artean irauten du normalean.</p><p>Alboz etzanda ipiniko zara, kokilduta, edo eserita apur bat aurrera makurtuta. Profesionalak gerriaren inguruko gunea garbituko du —bizkarraren beheko aldea— antiseptikoarekin, eta anestesia lokala jarriko du orratza sartuko den puntu zehatzean. Anestesia hori izango da sentituko duzun lehenengo gauza: azaleko ziztada txiki bat, besoan injekzio bat jartzen zaizunekoaren antzekoa.</p><p>Ondoren, gunea jada lo dagoenean, orratz oso fin bat sartzen da, ehunak zeharkatuz, LZR dagoen gunera heldu arte. Mililitro gutxi batzuk jasotzen dira —kantitate txikia, gorputzak denbora laburrean berritzen duena— eta orratza kentzen da. Amaieran, etxera joan aurretik pixka batean etzanda atseden hartzeko eskatuko zaizu.</p><h3>Ohiko zalantza bat</h3><p>Jende askok, "giltzurrun-zilborrestearen zulaketa" entzunda, irudikatzen du orratzak muinari ukitzen diola. Ez da horrela: zulaketa muina bukatzen den tokiaren azpian egiten da, LZR eta erraz baztertzen diren nerbio-sustrai fin batzuk baino ez dauden gunean. Horregatik da segurua prozedura, eta horregatik egiten da ohikoa mundu osoko ospitaleetan.</p><h3>Zer sentituko duzun eta zer gerta daiteken ondoren</h3><p>Probak iraun bitartean, molestenena jarrera eta orratzaren presioa izaten dira; minak, baldin badago, moderatua eta laburra izaten dira, anestesia lokalari esker. Badira ezer ez sentitzen ez duten pertsonak; beste batzuek nabariago den presio-sentsazio bat deskribatzen dute. Biak dira normalak.</p><p>Proba egin ondoren, pertsona batzuek —ez guztiek— hurrengo orduetan edo egunetan "zulaketa osteko buruko mina" ezagun den buruko min bat nabari dezakete, etzatean, likidoak edatean eta paracetamola hartzean arindu ohi dena. Gaur egun, hori gerta dadin probabilitatea nabarmen murrizten duten diseinu berezidun orratzak erabiltzen dira, eta agertzen denean, egun bat edo bitan konpondu ohi da. Nola ezagutzen den eta agertuz gero zer egin behar den azalduko zaizu.</p><p>Honetaz gain, prozedura oso segurua da. Konplikazio larriak ikaragarri arraroak dira, eta arreta ematen dizun taldeak ondo ezagutzen du nola prebenitu.</p><h3>Zer informazio ematen digun</h3><p>LZR lagin txiki batetik oso informazio aberatsa atera daiteke:</p><ul><li>Burmuina nola ari den funtzionatzen islatzen duten <strong>nerbio-sistemako proteina espezifikoen neurketa</strong> bat, egoera orokorraren adierazle txikien gisa.</li><li><strong>Prioi-proteinarekin lotutako jarduera zuzenean detektatzea</strong>, kantitate ñimiñoak detektatzeko gai diren teknika sentikorren bidez.</li><li><strong>Ikuspegi orokor</strong> bat, denboran zehar errepikatzean, multzo konparagarria eraikitzeko aukera ematen duena: EMNrekin gertatzen den bezala, lagin bakoitzak zentzua hartzen du aurrekoekin alderatzen denean.</li></ul><h3>LZR aztertzen duten teknikak</h3><p>Lagina lortu ondoren, laborategiko lana hasten da. Aplika daitezkeen hainbat teknika daude, bakoitza galdera desberdin bati erantzuteko diseinatua. Prioi-gaixotasunen testuinguruan esanguratsuenak bi dira: <strong>RT-QuIC</strong> eta <strong>PMCA</strong>: metodo oso modernoak dira, gaizki tolestutako prioi-proteinaren kantitate txikiak detektatzeko gai direnak, baita sintomak agertu baino urte batzuk lehenago ere.</p><p>Biei buruz xehetasunez hitz egingo dugu <em>Atzeko zientzia</em> atalaren pilula propioetan, nahikoa liluragarriak baitira berez merezi izateko. Oraingoz, nahikoa da jakitea zure lagina ez dela kaxoi batean gelditzen: esku adituetatik eta azken belaunaldiko teknikekin pasatzen da.</p><h3>Zenbat sarritan errepikatzen den</h3><p>Programako gainerako probekin bezala, giltzurrun-zilborrestearen zulaketaren maiztasuna zure mutazioari lotutako gaixotasunaren hasiera-adin mediara doitzen da. Erreferentzia gisa, Familiako Insomnio Hilgarrian sintomen hasierako batez besteko adina 49 urte ingurukoa da, eta Creutzfeldt-Jakob gaixotasun genetikoan 58 urte ingurukoa. Hortik aurrera, programaren irizpidea hau da:</p><table><thead><tr><th>Zure egoera batez besteko hasieraren aldean</th><th>Giltzurrun-zilborrestearen zulaketaren maiztasuna</th></tr></thead><tbody><tr><td>20 urte baino gehiago lehenago</td><td>3 urtean behin</td></tr><tr><td>20 eta 10 urte bitartean lehenago</td><td>2 urtean behin</td></tr><tr><td>10 urte baino gutxiago lehenago, edo batez besteko adinetik gorakoa</td><td>Urtero</td></tr></tbody></table><p>Logika gainerako jarraipenean bezalakoa da: estatistikoki aldaketak ager litezkeen frankjatik gertuago egon, orduan eta baliagarriagoa da maiz begiratzea. Eta, beti bezala, ez duzu kontua eraman behar: programak jakinarazten dizu noiz egokitzen den.</p>',
    'pildoras.puncion-lumbar.conclusion':   'Giltzurrun-zilborrestearen zulaketa da, seguruenik, programako probarik beldurgarriena, baina, praktikan, jendeak irudikatzen duena baino askoz gutxiago gogaikarria izaten da. Trukean, zerbait paregabea eskaintzen du: nerbio-sistemarako zuzeneko leihoa, beste inongo probak ireki ezin duena. Ematen diguzun lagin bakoitza egiten ari garen lan bateratuaren pieza txiki baina izugarri baliotsu bat da, eta zeure burua orainean zaintzeko eta datorrenerako prestatzeko modu zehatz bat.',

    /* Polisomnografia pilula (kategoria: probak; bereziki baliagarria FFI eramaileetan) */
    'pildoras.polisomnografia.titulo':       'Zure garunak lo zauden bitartean kontatzen duena',
    'pildoras.polisomnografia.resumenCorto': 'Polisomnografia lo-azterketa bat da, gauean zure garuna nola funtzionatzen duen ikusteko aukera ematen duena. Familiako Insomnio Hilgarriaren eramaileen artean, programako prueba sentikorrenetako bat da. Nolakoa den eta zergatik merezi duen kontatzen dizugu.',
    'pildoras.polisomnografia.resumen':      'Polisomnografia lo-gau batean zure gorputzean gertatzen dena erregistratzen duen proba bat da: garunaren jarduera elektrikoa, begien mugimenduak, arnasketa, bihotz-erritmoa, muskuluen tonua. Familiako Insomnio Hilgarriaren eramaileen jarraipenean baliotsuenetakoa da, mutazio honi lotutako aldaketak loan askoz lehenago agertzen direlako beste inon baino.',
    'pildoras.polisomnografia.desarrollo':   '<h3>Bereziki Familiako Insomnio Hilgarriaren eramaileentzat pentsatutako proba bat</h3><p>Programako beste proba batzuekin ez bezala, polisomnografia ez zaie eramaile guztiei egiten. Balio bereziki handia du Familiako Insomnio Hilgarriari lotutako mutazioa duten pertsonetan, izan ere, gaixotasun horretan detektagarri diren lehen aldaketak loaren arkitekturan gertatzen dira, hain zuzen. Horregatik, beste mutazio bat baduzu, ziurrenik ez dizute proposatuko.</p><p>Hau ez da hierarkia bat ezta esklusio bat ere: proba bakoitzak indargune desberdin bat dauka, eta informazio gehiena ematen duten tokietan erabiltzea zure denbora eta erosotasuna zaintzeko modu bat ere bada.</p><h3>Loa ez da pasiboa</h3><p>Urteetan zehar pentsatu zen loa itzalita egoteko egoera bat zela. Gaur egun badakigu guztiz kontrakoa dela: lo zauden bitartean, zure garuna izugarri antolatutako lan bat egiten ari da. Egunean zehar ikasitakoa finkatzen du, hondakin molekularrak garbitzen ditu, hormonak arautzen ditu, erritmoak zuzentzen. Ziklikoki errepikatzen diren hainbat faseren bidez egiten du hori, bakoitzak bere jarduera-patroi propioarekin.</p><p>Fase horien artean seinale bereziki interesgarri bat dago: <em>lo-matazak</em> deituak. Garunak lo sakonaren une zehatz batzuetan sortzen dituen jarduera elektriko erritmiko lehergai txikiak dira, pultsu antolatuen antzera. Garunaren talamo izeneko eskualde batek sortzen ditu, eta haien presentzia, forma eta kantitatea talamoa ondo funtzionatzen ari denaren adierazle oso fidagarria da.</p><p>Familiako Insomnio Hilgarrian, talamoa da eragina jasotzen duen eskualdea hain zuzen. Horregatik, lo-matazek arrasto sotilak eman ditzakete beste edozein probak baino askoz lehenago, baita sintomak agertu baino urte batzuk lehenago ere.</p><h3>Nolakoa den proba, urratsez urrats</h3><p>Polisomnografia lo-unitate batean egiten da, normalean ospitale batean. Gau oso bat pasatuko duzu bertan.</p><p>Arratsalde-iluntzean iristean, teknikari batek prestatuko zaitu: gorputzeko hainbat tokitan itsatsiko dizkizu sentsore txikiak pasta berezi batekin. Buruko larruan garunaren jarduera elektrikoa erregistratzeko, begien inguruan begien mugimenduak jasotzeko, kokotzean eta hanketan muskuluen tonua neurtzeko, bularrean bihotzarena, eta zinta leun batzuk toraxaren eta sabelaren inguruan arnasketa neurtzeko. Hatzean ere sentsore txiki bat eramango duzu oxigenazioa neurtzeko.</p><p>Kable asko diruditen arren, eta badira, sentsoreak txikiak dira eta ahalik eta gutxien enbarazu egiteko diseinatuak daude. Jarri ondoren, mugitu zaitezke, biratu zaitezke, komunera joan zaitezke teknikariaren laguntzarekin.</p><p>Ondoren, ohe arrunt batean etzaten zara, gela lasai eta ilun batean. Ekipoak gau osoan zehar erregistratzen du, zuk ezer egin beharrik gabe. Goizean, teknikariak sentsoreak kentzen ditu eta etxera joaten zara.</p><h3>Nolakoa den, benetan, han gaua pasatzea</h3><p>Denek egiten duten galdera da, eta gutxik ausartzen dira egitera. Erantzun zintzoa: <em>arraroa da lehen aldian</em>. Zurea ez den ohe batean lo egitea, gorputzean kableak dituzula, gela ezezagun batean, ospitaleko eraikin batean… ez da munduko gauzarik naturalena. Jende askok gau horretan ohi baino okerrago lo egiten du.</p><p>Eta hori da, hain zuzen, berri ona: ez da behar guztiz ondo lo egin. Azterketak informazio baliagarria jasotzen du loa ohi baino zatituago dagoenean ere. Aztertzen dena ez da <em>zenbat</em> lo egin duzun, <em>nolakoa</em> izan den loaren arkitektura lo egin duzunean baizik. Ordu gutxi batzuk bakarrik lo egin arren, datuak baliozkoak dira.</p><p>Aholku praktiko batzuk lagungarriak izaten dira: maitasuna diozun pijama eroso bat eramatea, zure burukoa ahal baduzu, argia itzali aurretik irakurtzeko zerbait, egun horretan ez kaferik ez alkoholik ez hartzea. Eta, batez ere, lasai joatea: taldea ohituta dago parte-hartzaileak etxean bezala ez lo egitera, eta horrekin ezin hobeto lan egiten jakite dute.</p><h3>Zer informazio ematen digun</h3><p>Ongi erregistratutako gau batetik informazio asko atera daiteke:</p><ul><li>Zure <strong>loaren arkitekturaren mapa xehea</strong>: fase bakoitzean zenbat denbora ematen duzun, zer kalitaterekin, zer egonkortasunarekin.</li><li><strong>Lo-matazen analisi fina</strong>: haien kopurua, maiztasuna, banaketa. Familiako Insomnio Hilgarrian, hau da daturik baliotsuena.</li><li><strong>Arnasketaren, bihotz-erritmoaren eta gauean zeharreko mugimenduen</strong> inguruko informazioa, zure mutazioarekin zerikusirik ez duten loaren beste alterazio batzuk baztertzeko aukera ematen duena, apneak edo beste fenomeno batzuk adibidez.</li></ul><h3>Zenbat sarritan errepikatzen den</h3><p>Programako gainerako probekin bezala, polisomnografiaren maiztasuna sintomen hasierako batez besteko adinera doitzen da. Familiako Insomnio Hilgarriarentzat, adin hori 49 urte ingurukoa da. Hortik aurrera, programaren irizpidea hau da:</p><table><thead><tr><th>Zure egoera batez besteko hasieraren aldean</th><th>Polisomnografiaren maiztasuna</th></tr></thead><tbody><tr><td>20 urte baino gehiago lehenago</td><td>3 urtean behin</td></tr><tr><td>20 eta 10 urte bitartean lehenago</td><td>2 urtean behin</td></tr><tr><td>10 urte baino gutxiago lehenago, edo batez besteko adinetik gorakoa</td><td>Urtero</td></tr></tbody></table><p>Logika gainerako jarraipenean bezalakoa da: estatistikoki aldaketak ager litezkeen frankjatik gertuago egon, orduan eta baliagarriagoa da maiz begiratzea. Eta, beti bezala, programak jakinarazten dizu noiz egokitzen den.</p>',
    'pildoras.polisomnografia.conclusion':   'Polisomnografia programaren baitan proba berezi bat da: eramaile guztiek ez dute egiten, eta eskatzeak etxeko lo-gau bati uko egitea dakar. Trukean, beste inolako probak ematen ez duen zerbait eskaintzen du: zure garunak gauero egiten duen isileko lanerako leihoa, eta inork baino lehen aldaketa sotil bat detektatzeko aukera, inoiz gertatuko balitz. Nolabait esateko, zure garunari uztea atseden hartzen duzun bitartean zure ordez hitz egiten.',

    /* Odol-erauzketa pilula (kategoria: probak; taularik gabe, urteroko kadentzia finkoa) */
    'pildoras.extraccion-sangre.titulo':       'Denborarekin balioa hartzen duen lagina',
    'pildoras.extraccion-sangre.resumenCorto': 'Minutu gutxiko odol-erauzketa batek gaur egun duela hamar urte neurtu ezin genituen gauzak neurtzeko aukera ematen du, eta bihar oraindik existitzen ez diren gauzak neurtzeko aukera emango du. Zer aztertzen den eta zergatik proba hau den, seguruenik, gehien aldatzen ari dena kontatzen dizugu.',
    'pildoras.extraccion-sangre.resumen':      'Odol-erauzketa programako probarik errazena da. Denok pasa gara noizbait analitikaren batetik, beraz ez dugu deskribapenari espazio handirik eskainiko. Interesgarriena ez da proba bera, laginarekin egin dezakeguna baizik: odoleko biomarkatzaileen arloa eraldaketa bizkor bat bizitzen ari da, eta urteko erauzketa bakar batek aurrerapen horretan parte hartzeko aukera ematen dizu, ia ahaleginik gabe zure aldetik.',
    'pildoras.extraccion-sangre.desarrollo':   '<h3>Odola, LZR-aren bertsio eskuragarria</h3><p>Giltzurrun-zilborrestearen zulaketaz hitz egin genuenean, likido zefalorrakideoa nerbio-sistemaren ispilu zintzoena zela esaten genuen. Odola desberdina da: eskuragarriagoa, ugariagoa, biltzeko errazagoa, baina <em>zaratatsuagoa</em> ere bai. Garunak seinaleak uzten ditu odolean, baina diluituak, gorputzaren gainerakoak ekartzen duen guztiarekin nahastuak. Hamarkadetan zehar seinale horiek hain ahulak ziren, non ezin baikenituen hondoko zaratatik bereizi.</p><p>Hori aldatzen ari da. Detekzio-teknika berriak odolean molekula zehatzen kontzentrazio izugarri txikiak neurtzeko gai dira, lehen LZR-an bakarrik detektatu genitzakeenak. Urtero, orain arte giltzurrun-zilborrestearen zulaketa bidez bakarrik azter zitekeen biomarkatzaile bat erauzketa arrunt batean neurgarri bihurtzen hasten da.</p><h3>Zer neurtu dezakegun gaur</h3><p>Arlo honetako biomarkatzaile helduena <strong>NfL</strong> deitzen da, ingelesezko bere siglengatik, <em>neurofilament light chain</em> (neurofilamentuaren kate arina). Neurofilamentuak neuronen barne-egituraren parte dira, zutik mantentzen dituen hezurdura bat bezala. Neurona batek sufritzen duenean, NfL kantitate txikiak askatzen ditu ingurura, odolera iristen amaitzen direnak. Maila altuetan agertzeak adierazle fidagarri bat da, nerbio-sistemaren nonbait zerbait gertatzen ari dela erakusten duena.</p><p>PRNP genearen mutazioen eramaile asintomatikoekin egindako azken ikerketetan, odoleko NfL igotzen hasten da sintomak agertu baino bi urte lehenagora arte. Ez da tresna diagnostiko behin-betikoa, baina bai adierazle goiztiar baliotsua, bereziki denboran errepikatzen denean eta zure aurreko mailekin alderatzen denean.</p><p>NfL-arekin batera, protagonismoa hartzen ari den beste biomarkatzaile sortzaile bat dago: <strong>GFAP</strong>, astrozito deitzen diren garuneko laguntza-zelulek ekoizten duten proteina bat. Zelula horiek aktibatzen direnean —neurona-ingurunea aldatzen denean gertatzen dena—, GFAP askatzen da eta odolera ere iristen da. Bitxiki, NfL-ak eta GFAP-ak gauza desberdinak islatzen dituzte: batak neurona-kalte zuzena adierazten du, besteak neuronen inguruko zelulen erantzuna. Elkarrekin, bakoitzak bere aldetik emango lukeena baino erretratu osatuagoa ematen dute.</p><p>Eta bi horietatik haratago, ikerketan dauden beste hautagai batzuk daude (tau proteinaren aldaerak, sinukleina, YKL-40, eta beste batzuk) erritmo desberdinetan heltzen ari direnak. Batzuk sendotuko dira, beste batzuk seguruenik ez. Horrela egiten du aurrera zientziak: gauza asko probatzen, batzuk baliozkotzen eta beste batzuk zintzotasun berarekin baztertzen.</p><h3>Momentu historiko bat arloan</h3><p>Duela hamar urte, gaixotasun neurodegeneratiboetarako odoleko biomarkatzaileez hitz egitea ia zientzia-fikzioa zen. Gaur egun, panorama erabat aldatzen ari diren ultrasentikortasun-teknikak daude. Datozen urteetan zentzuzkoa da biomarkatzaile berriak agertzea espero izatea, daudenak findu daitezela, eta horietako batzuen konbinazioak gaur oraindik ezin ditugun galderak erantzuten lagun dezala.</p><p>Programa honetan parte hartzeak aurrerapen horren lehen lerroan kokatzen zaitu. Erauzketa bakoitzak laboratorioek beren teknikak findu ditzaten, emaitza longitudinalak konparatu ditzaten, eta biomarkatzaile hauek fase aurrekliniko duten portaeraren mapa xehea eraiki dezaten laguntzen du.</p><h3>Biobankua: etorkizun hobe baterako gordetako laginak</h3><p>Erauzten den guztia ez da berehala aztertzen. Lagin bakoitzaren zati bat arretaz gordetzen da, oso tenperatura baxuan izoztuta, biobanku deitzen zaionean. Lagin horiek programaren eskura geratzen dira etorkizunean aztertzeko, gaur oraindik asmatu ez diren teknikak existitzen direnean.</p><p>Jarraipen longitudinalaren ideia politenetako bat da hau: gaur hartutako zure odol-lagin bat bost edo hamar urte barru aztertu ahal izango da oraindik existitzen ez diren metodoekin, orduan garrantzitsuak izango diren baina gaur egin ezin ditugun galderak erantzuteko aukera emanez. Zure lagina, zentzu horretan, denboran zehar egindako bidaia txiki bat da: etorkizuneko informazioa du barruan.</p><h3>Zergatik egiten diren analisi hauek programa baten barruan</h3><p>Odoleko biomarkatzaileak itxaropentsuak dira, baina haien interpretazioak oraindik testuingurua behar du. NfL edo GFAP baten balio isolatu bat, erreferentziarik gabe eta jarraipenik gabe, erantzun baino galdera gehiago sor ditzake, eta batzuetan antsietate alferrikakoa ere bai. Horregatik, nazioarteko komunitate zientifikoak gomendatzen du analisi hauek beti antolatutako programen barruan egitea, mediku-jarraipenarekin eta balio bakoitza bere testuinguru pertsonalean eta historikoan jartzeko gaitasunarekin.</p><p>Programa honetan baldintza hori betetzen da: lagin bakoitza perspektibarekin aztertzen da, zure aurrekoekin alderatzen da, eta jarraipeneko gainerako probekin batera interpretatzen da. Ez da kribaketa soltea. Multzoko begirada batean txertatzen den zatia da, zainduta.</p><h3>Eta lotura bat etorkizun hurbilarekin</h3><p>Egunen batean entsegu kliniko bateko hautagai bihurtzen bazara —garatzen ari diren eta beste pilula batzuetan kontatuko ditugun terapia batzuekin—, zure erauzketen historiaren balioa biderkatu egingo da. Ikertzaileek jakin nahi izango dute nola zeuden zure biomarkatzaileak tratamendua hasi baino lehen, terapia funtzionatzen ari den zehaztasunez neurtu ahal izateko. Historia hori ezin da ondoren berreraiki: edo dago, edo ez dago. Zuk, urteroko erauzketa bakoitzarekin, eraikitzen ari zara.</p><h3>Nolakoa den erauzketa eta zenbat sarritan egiten den</h3><p>Gutxi gehitzeko: erauzketa estandar bat, hodi batzuekin, zure bizitzan hainbeste aldiz egin dituzunen antzera. Minutu batzuk. Ziztadaren molestia arin bat eta kito.</p><p>Kasu honetako maiztasunak ez du jarraitzen gainerako proben kadentzia eskailera-itxura (3/2/1 urte). Proba oso gutxi inbaditzailea eta oso bizkorra denez, <strong>urtean behin</strong> egiten da programaren hasieratik, adinaren edo gaixotasunaren batez besteko hasieratik duzun gertutasunaren aldetik. Programak uste badu inguruabarren batek erauzketa osagarri bat eskatzen duela (adibidez, EMN edo giltzurrun-zilborrestearen zulaketa batekin bat egitean), garaiz jakinaraziko zaizu.</p>',
    'pildoras.extraccion-sangre.conclusion':   'Odol-erauzketa da programako probarik apalena, baina agian jarraipenaren espiritua ondoen gorpuzten duena: zerbait txikia, denboran eutsia, intentsitateagatik baino iraunkortasunagatik baliotsu bihurtzen ari dena. Gaur zure odolak zientziak neurtzen dakiena kontatzen du. Bihar zientziak oraindik ikasten ari dena kontatuko du. Eta programa hemen dago elkarrizketa hori eten ez dadin bermatzeko.',

    /* 'Así es venir al programa' — itzultzear (EU) */
    'pildoras.dia-programa.titulo':       '[Itzultzear] Así es venir al programa',
    'pildoras.dia-programa.resumenCorto': '[Itzultzear — euskarazko itzulpena laster.] Una vez al año, dos días en el Hospital Universitario Araba.',
    'pildoras.dia-programa.resumen':      '[Itzultzear — euskarazko itzulpena laster.]',
    'pildoras.dia-programa.desarrollo':   '<p><em>Itzultzear — euskarazko itzulpen osoa laster. Bitartean, gaztelaniazko bertsiora jo dezakezu.</em></p>',
    'pildoras.dia-programa.conclusion':   '[Itzultzear — euskarazko itzulpena laster.]',
  ...
  ca: {
    ...
    /* Píndola Polisomnografia (categoria: proves; especialment útil en portadors d'IFF) */
    'pildoras.polisomnografia.titulo':       'El que el teu cervell explica mentre dorms',
    'pildoras.polisomnografia.resumenCorto': 'La polisomnografia és un estudi del son que permet observar com funciona el teu cervell durant la nit. En portadors d\'Insomni Familiar Fatal és una de les proves més sensibles del programa. T\'expliquem com és i per què val la pena.',
    'pildoras.polisomnografia.resumen':      'La polisomnografia és una prova que registra el que passa al teu cos durant una nit de son: l\'activitat elèctrica del cervell, els moviments oculars, la respiració, el ritme cardíac, el to muscular. És una de les proves més valuoses en el seguiment de portadors d\'Insomni Familiar Fatal, perquè els canvis relacionats amb aquesta mutació apareixen al son molt abans que enlloc més.',
    'pildoras.polisomnografia.desarrollo':   '<h3>Una prova pensada especialment per a portadors d\'IFF</h3><p>A diferència d\'altres proves del programa, la polisomnografia no es fa a tots els portadors. Té un valor especialment alt en persones portadores de la mutació associada a l\'Insomni Familiar Fatal, perquè els primers canvis detectables en aquesta malaltia passen precisament a l\'arquitectura del son. Per això, si ets portador d\'una altra mutació, probablement no te la proposaran.</p><p>Això no és una jerarquia ni una exclusió: simplement cada prova té una fortalesa diferent, i fer-les servir on són més informatives és una manera de cuidar també el teu temps i la teva comoditat.</p><h3>El son no és passiu</h3><p>Durant anys es va pensar que el son era un estat d\'apagament. Avui sabem que és just el contrari: mentre dorms, el teu cervell està duent a terme una feina extraordinàriament organitzada. Consolida el que ha après durant el dia, neteja residus moleculars, regula hormones, orquestra ritmes. Ho fa a través de diverses fases que es repeteixen cíclicament, cadascuna amb el seu propi patró d\'activitat.</p><p>Entre aquestes fases hi ha un senyal especialment interessant: els anomenats <em>fusos de son</em>. Són petites ràfegues rítmiques d\'activitat elèctrica que el cervell genera en certs moments del son profund, com polsos organitzats. Els genera una regió del cervell anomenada tàlem, i la seva presència, la seva forma i la seva quantitat són un indicador molt fiable que el tàlem funciona bé.</p><p>A l\'Insomni Familiar Fatal, el tàlem és precisament la regió que es veu afectada. Per això els fusos de son poden donar pistes subtils molt abans que qualsevol altra prova, fins i tot anys abans que apareguin símptomes.</p><h3>Com és la prova, pas a pas</h3><p>La polisomnografia es fa en una unitat de son, normalment en un hospital. Hi passaràs una nit sencera.</p><p>En arribar, al capvespre, un tècnic et prepararà: et col·locarà petits sensors adherits amb una pasta especial en diverses parts del cos. Al cuir cabellut per registrar l\'activitat elèctrica del cervell, a prop dels ulls per als moviments oculars, al mentó i a les cames per al to muscular, al pit per al cor, i unes cintes suaus al voltant del tòrax i l\'abdomen per mesurar la respiració. També duràs un petit sensor al dit per mesurar l\'oxigenació.</p><p>Poden semblar molts cables, i ho són, però els sensors són petits i estan dissenyats per ser el menys molestos possible. Un cop col·locats, et pots moure, girar, anar al bany amb ajuda del tècnic.</p><p>Després t\'estires en un llit normal, en una habitació tranquil·la i fosca. L\'equip grava tota la nit sense que hagis de fer res. Al matí, el tècnic retira els sensors i te\'n vas a casa.</p><h3>Com és, realment, passar la nit allà</h3><p>És la pregunta que tothom es fa i poques persones s\'atreveixen a formular. La resposta honesta: <em>és estrany la primera vegada</em>. Dormir en un llit que no és el teu, amb cables connectats al cos, en una habitació desconeguda, en un edifici hospitalari… no és la cosa més natural del món. Molta gent dorm pitjor del que és habitual aquella nit.</p><p>I aquesta és precisament la bona notícia: no cal dormir perfectament. L\'estudi captura informació útil fins i tot quan el son és més fragmentat del normal. El que s\'analitza no és <em>quant</em> has dormit, sinó <em>com</em> ha estat l\'arquitectura del son quan ho has fet. Encara que dormis només unes hores, les dades són vàlides.</p><p>Alguns consells pràctics que solen ajudar: portar un pijama còmode al qual tinguis afecte, el teu coixí si pots, alguna cosa per llegir abans d\'apagar el llum, no prendre cafè ni alcohol aquell dia. I, sobretot, anar tranquil: l\'equip està acostumat que els participants no dormin com a casa, i saben treballar perfectament amb això.</p><h3>Quina informació ens aporta</h3><p>D\'una sola nit ben registrada se\'n pot extreure moltíssima informació:</p><ul><li>Un <strong>mapa detallat de la teva arquitectura del son</strong>: quant de temps passes a cada fase, amb quina qualitat, amb quina estabilitat.</li><li>Una <strong>anàlisi fina dels fusos de son</strong>: el seu nombre, la seva freqüència, la seva distribució. A l\'IFF, aquesta és la dada més valuosa.</li><li>Informació sobre la <strong>respiració, el ritme cardíac i els moviments durant la nit</strong>, que permet descartar altres alteracions del son no relacionades amb la teva mutació, com apnees o altres fenòmens.</li></ul><h3>Cada quant es repeteix</h3><p>Com passa amb la resta de proves del programa, la freqüència de la polisomnografia s\'ajusta a l\'edat mitjana d\'inici dels símptomes. Per a l\'Insomni Familiar Fatal, aquesta edat ronda els 49 anys. A partir d\'aquí, el criteri del programa és aquest:</p><table><thead><tr><th>La teva situació respecte a l\'inici mitjà</th><th>Freqüència de la polisomnografia</th></tr></thead><tbody><tr><td>Més de 20 anys abans</td><td>Cada 3 anys</td></tr><tr><td>Entre 20 i 10 anys abans</td><td>Cada 2 anys</td></tr><tr><td>Menys de 10 anys abans, o per sobre de l\'edat mitjana</td><td>Cada any</td></tr></tbody></table><p>La lògica és la mateixa que a la resta del seguiment: com més a prop de la franja en què estadísticament podrien aparèixer canvis, més valuós és mirar amb freqüència. I, com sempre, el programa t\'avisa quan toca.</p>',
    'pildoras.polisomnografia.conclusion':   'La polisomnografia és una prova singular dins del programa: no tots els portadors la fan, i demanar-la suposa renunciar a una nit de son a casa. A canvi, ofereix alguna cosa que cap altra prova pot donar: una finestra al treball silenciós que el teu cervell fa cada nit, i la possibilitat de detectar abans que ningú un canvi subtil si alguna vegada ocorregués. És, en certa manera, deixar que el teu cervell parli per tu mentre descanses.',

    /* Píndola Extracció de sang (categoria: proves; sense taula, cadència anual fixa) */
    'pildoras.extraccion-sangre.titulo':       'La mostra que creix en valor amb el temps',
    'pildoras.extraccion-sangre.resumenCorto': 'Una extracció de sang de pocs minuts permet avui mesurar coses que fa deu anys no podíem, i demà permetrà mesurar coses que avui no existeixen. T\'expliquem què s\'analitza i per què aquesta prova és probablement la que més està canviant.',
    'pildoras.extraccion-sangre.resumen':      'L\'extracció de sang és la prova més senzilla del programa. Tots hem passat per una analítica alguna vegada, així que no dedicarem gaire espai a descriure-la. El que és interessant no és la prova en si, sinó el que podem fer amb la mostra: el camp dels biomarcadors en sang està vivint una transformació accelerada, i una sola extracció anual et permet participar en aquest avenç sense gairebé esforç per part teva.',
    'pildoras.extraccion-sangre.desarrollo':   '<h3>La sang, una versió accessible del LCR</h3><p>Quan parlàvem de la punció lumbar, dèiem que el líquid cefaloraquidi és el mirall més fidel del sistema nerviós. La sang és diferent: és més accessible, més abundant, més fàcil de recollir, però també més <em>sorollosa</em>. El cervell diposita senyals a la sang, però diluïts, barrejats amb tot el que aporta la resta del cos. Durant dècades aquests senyals eren tan febles que no els podíem distingir del soroll de fons.</p><p>Això està canviant. Les noves tècniques de detecció són capaces de mesurar concentracions minúscules de molècules específiques en sang, concentracions que abans només podíem detectar al LCR. Cada any, un biomarcador que fins ara només es podia estudiar per punció lumbar comença a ser mesurable en una simple extracció.</p><h3>Què podem mesurar avui</h3><p>El biomarcador més madur en aquest camp es diu <strong>NfL</strong>, per les seves sigles en anglès <em>neurofilament light chain</em> (cadena lleugera de neurofilament). Els neurofilaments són part de l\'estructura interna de les neurones, com un esquelet que les manté fermes. Quan una neurona pateix, allibera petites quantitats de NfL a l\'entorn, que acaben arribant a la sang. La seva presència en nivells elevats és un indicador fiable que en algun lloc del sistema nerviós està passant alguna cosa.</p><p>En estudis recents amb portadors asimptomàtics de mutacions del gen PRNP, el NfL en sang comença a elevar-se fins a 2 anys abans que apareguin símptomes. No és una eina diagnòstica definitiva, però sí un indicador primerenc valuós, especialment quan es repeteix en el temps i es compara amb els teus propis nivells previs.</p><p>Al costat del NfL, hi ha un altre biomarcador emergent que està agafant protagonisme: <strong>GFAP</strong>, una proteïna que produeixen unes cèl·lules de suport del cervell anomenades astròcits. Quan aquestes cèl·lules s\'activen —cosa que passa quan l\'entorn neuronal s\'altera—, el GFAP s\'allibera i arriba també a la sang. Curiosament, NfL i GFAP reflecteixen coses diferents: un indica dany neuronal directe, l\'altre una resposta de les cèl·lules que envolten les neurones. Junts donen un retrat més complet que qualsevol dels dos per separat.</p><p>I més enllà d\'aquests dos, hi ha altres candidats en investigació (variants de la proteïna tau, sinucleïna, YKL-40, i altres) que van madurant a ritmes diferents. Alguns es consolidaran, altres probablement no. Així avança la ciència: provant moltes coses, validant-ne unes i descartant-ne d\'altres amb la mateixa honestedat.</p><h3>Un moment històric en el camp</h3><p>Fa deu anys, parlar de biomarcadors en sang per a malalties neurodegeneratives era gairebé ciència-ficció. Avui hi ha tècniques d\'ultrasensibilitat que estan canviant per complet el panorama. En els pròxims anys és raonable esperar que apareguin nous biomarcadors, que els actuals es refinin, i que la combinació de diversos d\'ells permeti respondre preguntes que avui encara no sabem ni formular.</p><p>La teva participació en aquest programa et col·loca justament a la primera fila d\'aquest avenç. Cada extracció contribueix que els laboratoris puguin afinar les seves tècniques, comparar resultats longitudinals, i construir el mapa detallat del comportament d\'aquests biomarcadors en la fase preclínica.</p><h3>El biobanc: mostres guardades per a un futur millor</h3><p>No tot el que s\'extreu s\'analitza de seguida. Una part de cada mostra es guarda acuradament, congelada a molt baixa temperatura, en el que s\'anomena un biobanc. Aquestes mostres queden a disposició del programa per ser analitzades en el futur, quan existeixin tècniques que avui encara no s\'han inventat.</p><p>Aquesta és una de les idees més boniques del seguiment longitudinal: una mostra de la teva sang presa avui es podrà analitzar d\'aquí a cinc o deu anys amb mètodes que ni tan sols existeixen ara, permetent respondre preguntes que aleshores seran rellevants però que avui no ens podem fer. La teva mostra és, en aquest sentit, un petit viatge en el temps: conté informació futura.</p><h3>Per què aquestes anàlisis es fan en el marc d\'un programa</h3><p>Els biomarcadors en sang són prometedors, però la seva interpretació encara requereix context. Un valor aïllat de NfL o GFAP, sense referència i sense seguiment, pot generar més preguntes que respostes, i a vegades ansietat innecessària. Per això, la comunitat científica internacional recomana que aquestes anàlisis es facin sempre dins de programes organitzats, amb seguiment mèdic i amb la capacitat de posar cada valor en el seu context personal i històric.</p><p>En aquest programa aquesta condició es compleix: cada mostra s\'analitza amb perspectiva, es compara amb les teves prèvies, i s\'interpreta juntament amb la resta de proves del seguiment. No és un cribratge solt. És part d\'una mirada de conjunt, cuidada.</p><h3>I una connexió amb el futur proper</h3><p>Si algun dia arribes a ser candidat a un assaig clínic —amb alguna de les teràpies que estan sent desenvolupades i que explicarem en altres píndoles—, el valor del teu històric d\'extraccions es multiplicarà. Els investigadors voldran saber com estaven els teus biomarcadors abans de començar el tractament, per poder mesurar amb precisió si la teràpia està funcionant. Aquest històric no es pot reconstruir a posteriori: o es té, o no es té. Tu, amb cada extracció anual, l\'estàs construint.</p><h3>Com és l\'extracció i cada quant es fa</h3><p>Poc a afegir: una extracció estàndard, d\'uns pocs tubs, com tantes que has fet a la teva vida. Uns minuts. Lleugera molèstia del punxó i llestos.</p><p>La freqüència en aquest cas no segueix la cadència escalonada de les altres proves (3/2/1 anys). Com que és una prova molt poc invasiva i molt ràpida, es fa <strong>un cop l\'any</strong> des de l\'inici del programa, independentment de l\'edat o la proximitat a l\'inici mitjà de la malaltia. Si el programa considera que alguna circumstància requereix una extracció addicional (per exemple, en coincidir amb una RMN o una punció lumbar), se t\'informarà amb temps.</p>',
    'pildoras.extraccion-sangre.conclusion':   'L\'extracció de sang és la més humil de les proves del programa, però potser la que millor encarna l\'esperit del seguiment: alguna cosa petita, sostinguda en el temps, que es va fent valuosa per la constància més que per la intensitat. Avui la teva sang explica el que la ciència sap mesurar. Demà explicarà el que la ciència encara està aprenent. I el programa és aquí per assegurar-se que aquesta conversa no s\'interrompi.',

    /* 'Així és venir al programa' — pendent de traducció (CA) */
    'pildoras.dia-programa.titulo':       '[Pendent de traducció] Así es venir al programa',
    'pildoras.dia-programa.resumenCorto': '[Pendent de traducció — la versió catalana arribarà aviat.] Una vez al año, dos días en el Hospital Universitario Araba.',
    'pildoras.dia-programa.resumen':      '[Pendent de traducció — la versió catalana arribarà aviat.]',
    'pildoras.dia-programa.desarrollo':   '<p><em>Pendent de traducció — la versió catalana completa arribarà aviat. Mentrestant, pots consultar la versió en castellà.</em></p>',
    'pildoras.dia-programa.conclusion':   '[Pendent de traducció — la versió catalana arribarà aviat.]',
  ...
  gl: {
    ...
    /* Pílula Polisomnografía (categoría: probas; especialmente útil en portadores de IFF) */
    'pildoras.polisomnografia.titulo':       'O que o teu cerebro conta mentres dormes',
    'pildoras.polisomnografia.resumenCorto': 'A polisomnografía é un estudo do sono que permite observar como funciona o teu cerebro durante a noite. En portadores de IFF é unha das probas máis sensibles do programa. Contámosche como é e por que paga a pena.',
    'pildoras.polisomnografia.resumen':      'A polisomnografía é unha proba que rexistra o que ocorre no teu corpo durante unha noite de sono: a actividade eléctrica do cerebro, os movementos oculares, a respiración, o ritmo cardíaco, o ton muscular. É unha das probas máis valiosas no seguimento de portadores de Insomnio Familiar Fatal, porque os cambios relacionados con esta mutación aparecen no sono moito antes que en ningún outro sitio.',
    'pildoras.polisomnografia.desarrollo':   '<h3>Unha proba pensada especialmente para portadores de IFF</h3><p>A diferenza doutras probas do programa, a polisomnografía non se realiza en todos os portadores. Ten un valor especialmente alto en persoas portadoras da mutación asociada ao Insomnio Familiar Fatal, porque os primeiros cambios detectables nesta enfermidade ocorren precisamente na arquitectura do sono. Por iso, se es portador doutra mutación, probablemente non cha proporán.</p><p>Isto non é unha xerarquía nin unha exclusión: simplemente cada proba ten unha fortaleza distinta, e usalas onde son máis informativas é unha forma de coidar tamén o teu tempo e a túa comodidade.</p><h3>O sono non é pasivo</h3><p>Durante anos pensouse que o sono era un estado de apagado. Hoxe sabemos que é xusto o contrario: mentres dormes, o teu cerebro está realizando un traballo extraordinariamente organizado. Consolida o aprendido durante o día, limpa residuos moleculares, regula hormonas, orquestra ritmos. Faino a través de varias fases que se repiten ciclicamente, cada unha co seu propio patrón de actividade.</p><p>Entre estas fases hai un sinal especialmente interesante: os chamados <em>fusos de sono</em>. Son pequenas rajadas rítmicas de actividade eléctrica que o cerebro xera en certos momentos do sono profundo, como pulsos organizados. Están xerados por unha rexión do cerebro chamada tálamo, e a súa presenza, a súa forma e a súa cantidade son un indicador moi fiable de que o tálamo funciona ben.</p><p>No Insomnio Familiar Fatal, o tálamo é xusto a rexión que se ve afectada. Por iso os fusos de sono poden dar pistas sutís moito antes que calquera outra proba, mesmo anos antes de que aparezan síntomas.</p><h3>Como é a proba, paso a paso</h3><p>A polisomnografía realízase nunha unidade de sono, normalmente nun hospital. Pasarás unha noite completa alí.</p><p>Ao chegar, pola tarde-noite, un técnico preparará: colocaráche pequenos sensores adheridos cunha pasta especial en varias partes do corpo. No coiro cabeludo para rexistrar a actividade eléctrica do cerebro, preto dos ollos para os movementos oculares, no queixo e nas pernas para o ton muscular, no peito para o corazón, e unhas cintas suaves ao redor do tórax e do abdome para medir a respiración. Tamén levarás un pequeno sensor no dedo para medir a oxixenación.</p><p>Poden parecer moitos cables, e sono, pero os sensores son pequenos e están deseñados para ser o menos molestos posible. Unha vez colocados, podes moverte, darte a volta, ir ao baño coa axuda do técnico.</p><p>Despois déitaste nunha cama normal, nun cuarto tranquilo e escurecido. O equipo grava toda a noite sen que teñas que facer nada. Pola mañá, o técnico retira os sensores e vasche para a casa.</p><h3>Como é, realmente, pasar a noite alí</h3><p>É a pregunta que todo o mundo se fai e poucas persoas se atreven a formular. A resposta honesta: <em>é raro a primeira vez</em>. Durmir nunha cama que non é a túa, con cables conectados ao corpo, nun cuarto descoñecido, nun edificio hospitalario… non é o máis natural do mundo. Moita xente dorme peor do habitual esa noite.</p><p>E esa é precisamente a boa noticia: non fai falta durmir perfectamente. O estudo captura información útil mesmo cando o sono é máis fragmentado do normal. O que se analiza non é <em>canto</em> durmiches, senón <em>como</em> foi a arquitectura do sono cando o fixeches. Aínda que durmas só unhas horas, os datos son válidos.</p><p>Algúns consellos prácticos que adoitan axudar: levar un pixama cómodo ao que teñas cariño, a túa almofada se podes, algo para ler antes de apagar a luz, non tomar café nin alcohol ese día. E, sobre todo, ir tranquilo: o equipo está afeito a que os participantes non durman como na casa, e saben traballar perfectamente con iso.</p><h3>Que información nos achega</h3><p>Dunha soa noite ben rexistrada pódese extraer moitísima información:</p><ul><li>Un <strong>mapa detallado da túa arquitectura do sono</strong>: canto tempo pasas en cada fase, con que calidade, con que estabilidade.</li><li>Unha <strong>análise fina dos fusos de sono</strong>: o seu número, a súa frecuencia, a súa distribución. No IFF, este é o dato máis valioso.</li><li>Información sobre a <strong>respiración, o ritmo cardíaco e os movementos durante a noite</strong>, que permiten descartar outras alteracións do sono non relacionadas coa túa mutación, como apneas ou outros fenómenos.</li></ul><h3>Cada canto se repite</h3><p>Como ocorre co resto de probas do programa, a frecuencia da polisomnografía axústase á idade media de inicio dos síntomas. Para o Insomnio Familiar Fatal, esa idade ronda os 49 anos. A partir de aí, o criterio do programa é este:</p><table><thead><tr><th>A túa situación respecto ao inicio medio</th><th>Frecuencia da polisomnografía</th></tr></thead><tbody><tr><td>Máis de 20 anos antes</td><td>Cada 3 anos</td></tr><tr><td>Entre 20 e 10 anos antes</td><td>Cada 2 anos</td></tr><tr><td>Menos de 10 anos antes, ou por encima da idade media</td><td>Cada ano</td></tr></tbody></table><p>A lóxica é a mesma que no resto do seguimento: canto máis preto da franxa en que estatisticamente poderían aparecer cambios, máis valioso é mirar con frecuencia. E, como sempre, o programa avísache cando toca.</p>',
    'pildoras.polisomnografia.conclusion':   'A polisomnografía é unha proba singular dentro do programa: non todos os portadores a fan, e pedila supón renunciar a unha noite de sono na casa. A cambio, ofrece algo que ningunha outra proba pode dar: unha ventá ao traballo silencioso que o teu cerebro realiza cada noite, e a posibilidade de detectar antes que ninguén un cambio sutil se algunha vez ocorrese. É, en certo modo, deixar que o teu cerebro fale por ti mentres descansas.',

    /* Pílula Extracción de sangue (categoría: probas; sen táboa, cadencia anual fixa) */
    'pildoras.extraccion-sangre.titulo':       'A mostra que medra en valor co tempo',
    'pildoras.extraccion-sangre.resumenCorto': 'Unha extracción de sangue de poucos minutos permite hoxe medir cousas que hai dez anos non podiamos, e mañá permitirá medir cousas que hoxe non existen. Contámosche que se analiza e por que esta proba é probablemente a que máis está cambiando.',
    'pildoras.extraccion-sangre.resumen':      'A extracción de sangue é a proba máis sinxela do programa. Todos pasamos por unha analítica algunha vez, así que non dedicaremos moito espazo a describila. O interesante non é a proba en si, senón o que podemos facer coa mostra: o campo dos biomarcadores en sangue está vivindo unha transformación acelerada, e unha soa extracción anual permíteche participar nese avance sen case esforzo pola túa parte.',
    'pildoras.extraccion-sangre.desarrollo':   '<h3>O sangue, unha versión accesible do LCR</h3><p>Cando falabamos da punción lumbar, dicíamos que o líquido cefalorraquídeo é o espello máis fiel do sistema nervioso. O sangue é distinto: é máis accesible, máis abundante, máis fácil de recoller, pero tamén máis <em>ruidoso</em>. O cerebro deposita sinais no sangue, pero diluídas, mesturadas con todo o que achega o resto do corpo. Durante décadas esas sinais eran tan ténues que non as podiamos distinguir do ruído de fondo.</p><p>Iso está cambiando. As novas técnicas de detección son capaces de medir concentracións minúsculas de moléculas específicas en sangue, concentracións que antes só podiamos detectar no LCR. Cada ano, un biomarcador que ata agora só se podía estudar por punción lumbar comeza a ser medible nunha simple extracción.</p><h3>Que podemos medir hoxe</h3><p>O biomarcador máis maduro neste campo chámase <strong>NfL</strong>, polas súas siglas en inglés <em>neurofilament light chain</em> (cadea lixeira de neurofilamento). Os neurofilamentos son parte da estrutura interna das neuronas, como un esqueleto que as mantén firmes. Cando unha neurona sofre, libera pequenas cantidades de NfL ao contorno, que acaban chegando ao sangue. A súa presenza en niveis elevados é un indicador fiable de que nalgún lugar do sistema nervioso está a ocorrer algo.</p><p>En estudos recentes con portadores asintomáticos de mutacións do xene PRNP, o NfL en sangue comeza a elevarse ata 2 anos antes de que aparezan síntomas. Non é unha ferramenta diagnóstica definitiva, pero si un indicador temperán valioso, especialmente cando se repite no tempo e se compara cos teus propios niveis previos.</p><p>Xunto ao NfL, hai outro biomarcador emerxente que está cobrando protagonismo: <strong>GFAP</strong>, unha proteína que producen unhas células de apoio do cerebro chamadas astrocitos. Cando estas células se activan —algo que ocorre cando o contorno neuronal se altera—, o GFAP libérase e chega tamén ao sangue. Curiosamente, NfL e GFAP reflicten cousas distintas: un indica dano neuronal directo, o outro unha resposta das células que rodean ás neuronas. Xuntos dan un retrato máis completo que calquera dos dous por separado.</p><p>E máis alá destes dous, hai outros candidatos en investigación (variantes da proteína tau, sinucleína, YKL-40, e outros) que van madurando a distinto ritmo. Algúns consolidaranse, outros probablemente non. Así avanza a ciencia: probando moitas cousas, validando unhas e descartando outras coa mesma honestidade.</p><h3>Un momento histórico no campo</h3><p>Hai dez anos, falar de biomarcadores en sangue para enfermidades neurodexenerativas era case ciencia ficción. Hoxe hai técnicas de ultrasensibilidade que están cambiando por completo o panorama. Nos próximos anos é razoable esperar que aparezan novos biomarcadores, que os actuais se refinen, e que a combinación de varios deles permita responder preguntas que hoxe aínda non sabemos nin formular.</p><p>A túa participación neste programa colócache xusto na primeira fila dese avance. Cada extracción contribúe a que os laboratorios poidan afinar as súas técnicas, comparar resultados lonxitudinais, e construír o mapa detallado do comportamento destes biomarcadores na fase preclínica.</p><h3>O biobanco: mostras gardadas para un futuro mellor</h3><p>Non todo o que se extrae se analiza inmediatamente. Unha parte de cada mostra gárdase coidadosamente, conxelada a moi baixa temperatura, no que se chama un biobanco. Estas mostras quedan a disposición do programa para seren analizadas no futuro, cando existan técnicas que hoxe aínda non se inventaron.</p><p>Esta é unha das ideas máis bonitas do seguimento lonxitudinal: unha mostra do teu sangue tomada hoxe poderase analizar dentro de cinco ou dez anos con métodos que nin sequera existen agora, permitindo responder preguntas que entón serán relevantes pero que hoxe non podemos facérnolas. A túa mostra é, nese sentido, unha pequena viaxe no tempo: contén información futura.</p><h3>Por que estas análises se fan no marco dun programa</h3><p>Os biomarcadores en sangue son prometedores, pero a súa interpretación aínda require contexto. Un valor illado de NfL ou GFAP, sen referencia e sen seguimento, pode xerar máis preguntas que respostas, e ás veces ansiedade innecesaria. Por iso, a comunidade científica internacional recomenda que estas análises se realicen sempre dentro de programas organizados, con seguimento médico e coa capacidade de poñer cada valor no seu contexto persoal e histórico.</p><p>Neste programa esa condición cúmprese: cada mostra analízase con perspectiva, compárase coas túas previas, e interprétase xunto co resto de probas do seguimento. Non é un cribado solto. É parte dunha mirada de conxunto, coidada.</p><h3>E unha conexión co futuro próximo</h3><p>Se algún día chegas a ser candidato a un ensaio clínico —con algunha das terapias que están a ser desenvolvidas e que contaremos noutras pílulas—, o valor do teu histórico de extraccións multiplicarase. Os investigadores quererán saber como estaban os teus biomarcadores antes de comezar o tratamento, para poder medir con precisión se a terapia está funcionando. Ese histórico non se pode reconstruír a posteriori: ou se ten, ou non se ten. Ti, con cada extracción anual, estalo construíndo.</p><h3>Como é a extracción e cada canto se fai</h3><p>Pouco que engadir: unha extracción estándar, duns poucos tubos, como tantas que fixeches na túa vida. Uns minutos. Lixeira molestia do pinchazo e listo.</p><p>A frecuencia neste caso non segue a cadencia escalonada das demais probas (3/2/1 anos). Como é unha proba moi pouco invasiva e moi rápida, realízase <strong>unha vez ao ano</strong> desde o inicio do programa, independentemente da idade ou da proximidade ao inicio medio da enfermidade. Se o programa considera que algunha circunstancia require unha extracción adicional (por exemplo, ao coincidir cunha RMN ou unha punción lumbar), informarásete con tempo.</p>',
    'pildoras.extraccion-sangre.conclusion':   'A extracción de sangue é a máis humilde das probas do programa, pero quizais a que mellor encarna o espírito do seguimento: algo pequeno, sostido no tempo, que se vai facendo valioso pola constancia máis que pola intensidade. Hoxe o teu sangue conta o que a ciencia sabe medir. Mañá contará o que a ciencia aínda está aprendendo. E o programa está aquí para asegurarse de que esa conversación non se interrompa.',

    /* Pílula 'Así é vir ao programa' (categoría: experiencia) */
    'pildoras.dia-programa.titulo':       'Así é vir ao programa',
    'pildoras.dia-programa.resumenCorto': 'Unha vez ao ano, dous días no Hospital Universitario Araba. Contámosche como será esa visita desde que chegas ata que volves á casa, e que ocorre nos meses seguintes.',
    'pildoras.dia-programa.resumen':      'O programa concéntrase nunha visita anual de dous días ao Hospital Universitario Araba, en Vitoria-Gasteiz. Durante eses dous días realízanse todas as probas que toquen ese ano segundo a túa cadencia persoal. Esta pílula é o teu mapa anticipado: o que vas vivir desde que chegas ata que marchas, e como seguimos en contacto os meses seguintes.',
    'pildoras.dia-programa.desarrollo':   '<h3>Antes de vir</h3><p>Uns días antes da visita, recibirás unha comunicación do equipo coa información práctica: datas, hora de chegada, indicacións sobre desprazamento e aloxamento, e que debes traer contigo. Se vés de fóra do País Vasco, o programa cobre os gastos de viaxe e aloxamento, e axudarache coa loxística.</p><p>Recibirás tamén, con tempo, os documentos de consentimento informado que asinarás durante a visita. Poder leelos con calma na casa, preguntar dúbidas ao equipo antes de vir, e chegar coas ideas claras é parte do programa. Non é algo que haxa que asinar con présa.</p><h3>Día 1 — Tarde</h3><p>Á túa chegada ao hospital, recibirate o equipo do programa. A primeira persoa coa que te atoparás será probablemente a <strong>Dra. Izaro Kortazar</strong>, neuróloga do hospital e coordinadora clínica do programa. Ela é o teu punto de referencia durante toda a visita e tamén entre visitas.</p><p>A tarde do primeiro día está pensada para ir sen présa: unha conversación inicial coa Dra. Kortazar para poñerse ao día de como estás, unha revisión conxunta dos consentimentos, e as probas que non requiren preparación especial —a extracción de sangue, por exemplo, se toca ese ano—.</p><p>Despois do atardecer, se ese ano toca polisomnografía, pasarás á unidade de sono do hospital, onde un técnico che colocará os sensores e quedarás durmir. Todo o detalle sobre como é esa noite contámolo na pílula <em class="lazy-pild" data-target="polisomnografia">O que o teu cerebro conta mentres dormes</em>.</p><h3>Día 2 — Mañá</h3><p>Pola mañá cedo, o técnico da unidade de sono retirarache os sensores e poderás almorzar. A partir de aí, realízanse as probas do segundo día segundo o que toque ese ano: a resonancia magnética, a punción lumbar, e calquera outra proba específica prevista.</p><p>A orde habitual coloca a <strong>resonancia magnética antes da punción lumbar</strong>, por un motivo práctico: a imaxe da RMN axuda a confirmar que todo está en orde antes dun procedemento máis invasivo como a punción lumbar. Esta orde é importante, e coidámola sempre.</p><h3>Os consentimentos — un momento importante</h3><p>Durante a visita asinarás varios documentos de consentimento informado. Non é papelame rutineiro: cada consentimento describe que se che vai facer, con que fin, que se fará coas mostras e os datos, e cales son os teus dereitos. Asinalos é un acto reflexivo, e por iso o equipo dáche tempo, espazo e a posibilidade de preguntar todas as veces que necesites.</p><p>En termos xerais, asinarás consentimentos relacionados con:</p><ul><li>A <strong>realización das probas</strong> do programa (RMN, punción lumbar, polisomnografía, extracción de sangue).</li><li>O <strong>almacenamento de mostras biolóxicas</strong> para análises actuais e futuras —o biobanco—.</li><li>O <strong>uso dos teus datos clínicos</strong> de forma anonimizada dentro do programa e, se así o decides, en estudos científicos colaborativos.</li><li>A <strong>comunicación de resultados</strong> e como prefires recibilos.</li></ul><p>Podes retirar o teu consentimento en calquera momento, parcial ou totalmente, sen que iso afecte á túa relación co equipo nin ao teu dereito a seguir sendo acompañado polo programa se o desexas. Esta posibilidade non é unha fórmula: é real, e recordaráseche máis dunha vez.</p><h3>Antes de marchar</h3><p>Antes da alta, terás unha segunda conversación coa Dra. Kortazar. Nela revísase como foi todo, resólvense as dúbidas que xurdiron durante os dous días, e adiántaseche cando e como recibirás os resultados das probas realizadas. Esta conversación é tan importante coma as probas: é o momento no que pechas a visita con calma e sabendo que vén a continuación.</p><h3>Nos meses seguintes</h3><p>Volver á casa non significa desconectar do programa. Durante os meses ata a seguinte visita hai varios fíos de contacto:</p><ul><li>Os <strong>resultados das probas</strong> comunícanse de forma ordenada cando están dispoñibles. Algúns son inmediatos, outros requiren semanas de análise no laboratorio. Sempre se explican con contexto e sen deixar preguntas no aire.</li><li>A <em class="lazy-pild" data-target="historia-natural-app">app de historia natural</em> —que terá a súa propia pílula— acompáñache no teu día a día, permitíndoche rexistrar pequenas observacións que enriquecen o seguimento. É unha ferramenta opcional pero valiosa.</li><li>O <strong>equipo segue dispoñible</strong> para calquera dúbida que che xurda, clínica ou non. Podes escribir ou chamar cando o necesites, sen esperar á próxima visita.</li><li>A <strong>Dra. Kortazar</strong> mantén o teu seguimento clínico durante o ano, e é a túa interlocutora principal se aparece algunha pregunta médica específica.</li></ul><h3>A seguinte visita</h3><p>Uns meses antes de que toque a túa seguinte visita anual, o equipo porase en contacto contigo para coordinar datas. A cadencia exacta de cada proba axústase á túa situación persoal (como contamos nas pílulas de cada proba), e o programa leva a conta por ti. Ti non tes que lembrar nin calcular nada.</p>',
    'pildoras.dia-programa.conclusion':   'Vir ao programa é máis sinxelo do que parece a primeira vista. Son dous días concentrados, con todo o coidado posto para que te sintas ben acompañado, e logo unha presenza discreta pero constante do equipo durante o resto do ano. Non é unha cita médica ao uso: é unha forma de coidarte no presente, coa mirada tranquila posta no que poida vir.',
  ...
  en: {
    ...
    /* Polysomnography capsule (category: tests; especially useful in FFI carriers) */
    'pildoras.polisomnografia.titulo':       'What your brain tells while you sleep',
    'pildoras.polisomnografia.resumenCorto': 'Polysomnography is a sleep study that lets us observe how your brain works during the night. In carriers of FFI, it\'s one of the most sensitive tests in the program. We\'ll tell you what it\'s like and why it\'s worth it.',
    'pildoras.polisomnografia.resumen':      'Polysomnography is a test that records what happens in your body during a night of sleep: the brain\'s electrical activity, eye movements, breathing, heart rhythm, muscle tone. It\'s one of the most valuable tests in the follow-up of Fatal Familial Insomnia carriers, because the changes related to this mutation appear in sleep long before they do anywhere else.',
    'pildoras.polisomnografia.desarrollo':   '<h3>A test designed especially for FFI carriers</h3><p>Unlike other tests in the program, polysomnography isn\'t done on every carrier. It has a particularly high value in people carrying the mutation associated with Fatal Familial Insomnia, because the first detectable changes in this disease occur precisely in sleep architecture. That\'s why, if you\'re a carrier of a different mutation, it probably won\'t be proposed to you.</p><p>This isn\'t a hierarchy or an exclusion: each test simply has a different strength, and using them where they\'re most informative is also a way of looking after your time and comfort.</p><h3>Sleep is not passive</h3><p>For years, sleep was thought to be a state of shutdown. Today we know it\'s just the opposite: while you sleep, your brain is carrying out extraordinarily organized work. It consolidates what you\'ve learned during the day, clears molecular waste, regulates hormones, orchestrates rhythms. It does this through several phases that repeat cyclically, each with its own pattern of activity.</p><p>Among these phases there\'s a particularly interesting signal: the so-called <em>sleep spindles</em>. These are small rhythmic bursts of electrical activity that the brain generates at certain moments of deep sleep, like organized pulses. They\'re generated by a brain region called the thalamus, and their presence, shape, and quantity are a very reliable indicator that the thalamus is working well.</p><p>In Fatal Familial Insomnia, the thalamus is precisely the region that is affected. That\'s why sleep spindles can give subtle clues long before any other test, even years before symptoms appear.</p><h3>What the test is like, step by step</h3><p>Polysomnography is done in a sleep unit, usually in a hospital. You\'ll spend a whole night there.</p><p>When you arrive, in the late afternoon or evening, a technician will prepare you: they\'ll place small sensors attached with a special paste on various parts of your body. On the scalp to record the brain\'s electrical activity, near the eyes for eye movements, on the chin and legs for muscle tone, on the chest for the heart, and soft belts around the thorax and abdomen to measure breathing. You\'ll also wear a small sensor on your finger to measure oxygenation.</p><p>It may seem like a lot of cables —and it is—, but the sensors are small and designed to be as unobtrusive as possible. Once placed, you can move, turn over, go to the bathroom with the technician\'s help.</p><p>Then you lie down on a normal bed, in a quiet, darkened room. The equipment records all night without you having to do anything. In the morning, the technician removes the sensors and you go home.</p><h3>What it\'s really like to spend the night there</h3><p>It\'s the question everyone asks themselves and few dare to voice out loud. The honest answer: <em>it\'s strange the first time</em>. Sleeping in a bed that isn\'t yours, with cables attached to your body, in an unfamiliar room, in a hospital building… it\'s not the most natural thing in the world. Many people sleep worse than usual that night.</p><p>And that\'s precisely the good news: you don\'t need to sleep perfectly. The study captures useful information even when sleep is more fragmented than usual. What\'s analyzed isn\'t <em>how much</em> you slept, but <em>how</em> your sleep architecture went while you did. Even if you only sleep a few hours, the data are valid.</p><p>Some practical tips that tend to help: bring a comfortable pajama you\'re fond of, your own pillow if you can, something to read before the lights go off, no coffee or alcohol that day. And, above all, go relaxed: the team is used to participants not sleeping like they do at home, and they know perfectly well how to work with that.</p><h3>What information it gives us</h3><p>From a single well-recorded night, a great deal of information can be extracted:</p><ul><li>A <strong>detailed map of your sleep architecture</strong>: how much time you spend in each phase, with what quality, with what stability.</li><li>A <strong>fine analysis of sleep spindles</strong>: their number, frequency, distribution. In FFI, this is the most valuable piece of data.</li><li>Information about <strong>breathing, heart rhythm, and movements during the night</strong>, which allows other sleep disturbances unrelated to your mutation —such as apneas or other phenomena— to be ruled out.</li></ul><h3>How often it\'s repeated</h3><p>As with the other tests in the program, the frequency of polysomnography is adjusted to the average age of symptom onset. For Fatal Familial Insomnia, that age is around 49. From there, the program\'s criterion is this:</p><table><thead><tr><th>Your situation relative to the average onset</th><th>Polysomnography frequency</th></tr></thead><tbody><tr><td>More than 20 years before</td><td>Every 3 years</td></tr><tr><td>Between 20 and 10 years before</td><td>Every 2 years</td></tr><tr><td>Less than 10 years before, or above the average age</td><td>Every year</td></tr></tbody></table><p>The logic is the same as in the rest of the follow-up: the closer to the range in which changes could statistically appear, the more valuable it is to look often. And, as always, the program lets you know when it\'s due.</p>',
    'pildoras.polisomnografia.conclusion':   'Polysomnography is a singular test within the program: not every carrier does it, and asking for it means giving up a night\'s sleep at home. In return, it offers something no other test can give: a window into the silent work your brain does every night, and the possibility of detecting a subtle change sooner than anyone else, should one ever occur. It\'s, in a way, letting your brain speak for you while you rest.',

    /* Blood draw capsule (category: tests; no table, fixed annual cadence) */
    'pildoras.extraccion-sangre.titulo':       'The sample that grows in value over time',
    'pildoras.extraccion-sangre.resumenCorto': 'A few-minute blood draw lets us measure things today that we couldn\'t ten years ago, and tomorrow will let us measure things that don\'t yet exist. We\'ll tell you what\'s analyzed and why this test is probably the one that\'s changing the most.',
    'pildoras.extraccion-sangre.resumen':      'A blood draw is the simplest test in the program. We\'ve all had a blood test at some point, so we won\'t spend much space describing it. What\'s interesting isn\'t the test itself, but what can be done with the sample: the field of blood biomarkers is going through an accelerated transformation, and a single annual draw lets you take part in that progress with almost no effort on your side.',
    'pildoras.extraccion-sangre.desarrollo':   '<h3>Blood, an accessible version of CSF</h3><p>When we talked about the lumbar puncture, we said that cerebrospinal fluid is the most faithful mirror of the nervous system. Blood is different: more accessible, more abundant, easier to collect, but also <em>noisier</em>. The brain deposits signals into the blood, but diluted, mixed with everything the rest of the body contributes. For decades those signals were so faint that we couldn\'t tell them apart from background noise.</p><p>That\'s changing. New detection techniques can measure tiny concentrations of specific molecules in blood —concentrations that used to be detectable only in CSF. Each year, a biomarker that until now could only be studied by lumbar puncture starts to become measurable in a simple blood draw.</p><h3>What we can already measure today</h3><p>The most mature biomarker in this field is called <strong>NfL</strong>, short for <em>neurofilament light chain</em>. Neurofilaments are part of the internal structure of neurons, like a skeleton that keeps them firm. When a neuron suffers, it releases small amounts of NfL into the surrounding tissue, which eventually reach the blood. High levels of NfL are a reliable indicator that something is happening somewhere in the nervous system.</p><p>In recent studies with asymptomatic carriers of PRNP gene mutations, NfL in blood starts to rise up to 2 years before symptoms appear. It\'s not a definitive diagnostic tool, but it is a valuable early indicator, especially when repeated over time and compared with your own previous levels.</p><p>Alongside NfL, another emerging biomarker is gaining ground: <strong>GFAP</strong>, a protein produced by support cells in the brain called astrocytes. When these cells become activated —something that happens when the neuronal environment is altered— GFAP is released and also reaches the blood. Interestingly, NfL and GFAP reflect different things: one points to direct neuronal damage, the other to a response from the cells surrounding the neurons. Together they give a more complete picture than either of them alone.</p><p>And beyond these two, other candidates are under investigation (variants of the tau protein, synuclein, YKL-40, and others) maturing at different rates. Some will prove themselves, others probably won\'t. That\'s how science moves forward: trying many things, validating some, and discarding others with the same honesty.</p><h3>A historic moment in the field</h3><p>Ten years ago, talking about blood biomarkers for neurodegenerative diseases was almost science fiction. Today there are ultrasensitive techniques that are completely changing the picture. In the coming years, it\'s reasonable to expect new biomarkers to appear, existing ones to be refined, and combinations of several of them to let us answer questions we can\'t even formulate today.</p><p>Your participation in this program places you right at the front row of that progress. Each draw helps labs fine-tune their techniques, compare longitudinal results, and build the detailed map of how these biomarkers behave in the preclinical phase.</p><h3>The biobank: samples stored for a better future</h3><p>Not everything that\'s drawn is analyzed right away. Part of each sample is carefully stored, frozen at very low temperature, in what\'s called a biobank. These samples remain available to the program for future analysis, when techniques exist that haven\'t been invented yet.</p><p>This is one of the most beautiful ideas in longitudinal follow-up: a blood sample taken from you today may be analyzed five or ten years from now with methods that don\'t even exist now, making it possible to answer questions that will be relevant then but can\'t be asked today. Your sample is, in that sense, a small journey through time: it contains future information.</p><h3>Why these analyses are done within a program</h3><p>Blood biomarkers are promising, but their interpretation still requires context. An isolated value of NfL or GFAP, without reference and without follow-up, can raise more questions than it answers —and sometimes cause unnecessary anxiety. That\'s why the international scientific community recommends that these analyses always be done within organized programs, with medical follow-up and the ability to place each value in its personal and historical context.</p><p>In this program that condition is met: each sample is analyzed with perspective, compared with your previous ones, and interpreted alongside the rest of the tests in the follow-up. It isn\'t a stand-alone screen. It\'s part of a careful, holistic view.</p><h3>And a connection to the near future</h3><p>If you ever become a candidate for a clinical trial —with one of the therapies being developed and which we\'ll cover in other capsules—, the value of your extraction history will multiply. Researchers will want to know what your biomarkers looked like before treatment started, so they can measure precisely whether the therapy is working. That history can\'t be reconstructed after the fact: either you have it, or you don\'t. You, with each annual draw, are building it.</p><h3>What the draw is like and how often it\'s done</h3><p>Not much to add: a standard draw, a few tubes, like so many you\'ve had in your life. A few minutes. A slight pinch, and that\'s it.</p><p>The frequency here doesn\'t follow the tiered cadence of the other tests (3/2/1 years). Because it\'s a minimally invasive and very quick test, it\'s done <strong>once a year</strong> from the start of the program, regardless of age or proximity to the average age of onset. If the program judges that some circumstance requires an additional draw (for example, to coincide with an MRI or lumbar puncture), you\'ll be informed in advance.</p>',
    'pildoras.extraccion-sangre.conclusion':   'The blood draw is the humblest of the program\'s tests, but perhaps the one that best embodies the spirit of the follow-up: something small, sustained over time, growing in value through constancy more than through intensity. Today your blood says what science knows how to measure. Tomorrow it will say what science is still learning. And the program is here to make sure that conversation doesn\'t get interrupted.',

    /* 'What coming to the program is like' — translation pending (EN) */
    'pildoras.dia-programa.titulo':       '[Translation pending] Así es venir al programa',
    'pildoras.dia-programa.resumenCorto': '[Translation pending — the English version will arrive soon.] Once a year, two days at Hospital Universitario Araba.',
    'pildoras.dia-programa.resumen':      '[Translation pending — the English version will arrive soon.]',
    'pildoras.dia-programa.desarrollo':   '<p><em>Translation pending — the full English version will arrive soon. In the meantime, you can read the Spanish version.</em></p>',
    'pildoras.dia-programa.conclusion':   '[Translation pending — the English version will arrive soon.]',
