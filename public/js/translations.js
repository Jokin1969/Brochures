...
const TRANSLATIONS = {
  ...
  ca: {
    ...
    /* Punció Lumbar — pendent de traducció (CA) */
    'pildoras.puncion-lumbar.titulo':       '[Pendent de traducció] Escuchar al líquido que baña el cerebro',
    'pildoras.puncion-lumbar.resumenCorto': '[Pendent de traducció — la versió catalana arribarà aviat.] La punción lumbar permite obtener una pequeña muestra del líquido que rodea el cerebro y la médula.',
    'pildoras.puncion-lumbar.resumen':      '[Pendent de traducció — la versió catalana arribarà aviat.]',
    'pildoras.puncion-lumbar.desarrollo':   '<p><em>Pendent de traducció — la versió catalana completa arribarà aviat. Mentrestant, pots consultar la versió en castellà.</em></p>',
    'pildoras.puncion-lumbar.conclusion':   '[Pendent de traducció — la versió catalana arribarà aviat.]',
  ...
  gl: {
    ...
    /* Punción Lumbar — pendente de tradución (GL) */
    'pildoras.puncion-lumbar.titulo':       '[Pendente de tradución] Escuchar al líquido que baña el cerebro',
    'pildoras.puncion-lumbar.resumenCorto': '[Pendente de tradución — a versión galega chegará pronto.] La punción lumbar permite obtener una pequeña muestra del líquido que rodea el cerebro y la médula.',
    'pildoras.puncion-lumbar.resumen':      '[Pendente de tradución — a versión galega chegará pronto.]',
    'pildoras.puncion-lumbar.desarrollo':   '<p><em>Pendente de tradución — a versión galega completa chegará pronto. Mentres tanto, podes consultar a versión en castelán.</em></p>',
    'pildoras.puncion-lumbar.conclusion':   '[Pendente de tradución — a versión galega chegará pronto.]',
  ...
  en: {
    ...
    /* Lumbar Puncture — translation pending (EN) */
    'pildoras.puncion-lumbar.titulo':       '[Translation pending] Escuchar al líquido que baña el cerebro',
    'pildoras.puncion-lumbar.resumenCorto': '[Translation pending — the English version will arrive soon.] Lumbar puncture allows us to take a small sample of the fluid that surrounds the brain and spinal cord.',
    'pildoras.puncion-lumbar.resumen':      '[Translation pending — the English version will arrive soon.]',
    'pildoras.puncion-lumbar.desarrollo':   '<p><em>Translation pending — the full English version will arrive soon. In the meantime, you can read the Spanish version.</em></p>',
    'pildoras.puncion-lumbar.conclusion':   '[Translation pending — the English version will arrive soon.]',
