...
const TRANSLATIONS = {
  ...
  gl: {
    ...
    /* 'Así é vir ao programa' — pendente de tradución (GL) */
    'pildoras.dia-programa.titulo':       '[Pendente de tradución] Así es venir al programa',
    'pildoras.dia-programa.resumenCorto': '[Pendente de tradución — a versión galega chegará pronto.] Una vez al año, dos días en el Hospital Universitario Araba.',
    'pildoras.dia-programa.resumen':      '[Pendente de tradución — a versión galega chegará pronto.]',
    'pildoras.dia-programa.desarrollo':   '<p><em>Pendente de tradución — a versión galega completa chegará pronto. Mentres tanto, podes consultar a versión en castelán.</em></p>',
    'pildoras.dia-programa.conclusion':   '[Pendente de tradución — a versión galega chegará pronto.]',
